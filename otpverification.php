...
<nav class="navbar navbar-expand-lg navbar-light navbar-laravel">
    <div class="container">
        <a class="navbar-brand" href="#" style="color :white; ">Verification Account</a>
    ...
    if(isset($_POST["verify"])){
        ...
        if($otp != $otp_code){
           ...
           <?php
            ...
            mysqli_query($connect, "UPDATE login SET verifystatus = 1 WHERE email = '$email'");
            ?>
             <script>
                 alert("Account verified, you may proceed to vote now");
